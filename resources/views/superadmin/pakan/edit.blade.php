...
<div class="row">
    <div class="col-12">
        <form method="post" action="/pakan/edit/{{$data->id}}">
            @csrf
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">EDIT JADWAL PAKAN</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="time" class="form-control" name="food1" value="{{$data->food1}}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="time" class="form-control" name="food2" value="{{$data->food2}}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="time" class="form-control" name="food3" value="{{$data->food3}}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
